...
public class Xls_Reader {
	...
	public int getRowCount(String sheetName){
		...
		if(index==-1){
			System.out.println(sheetName+" Worksheet doesnt exist");		 
			return 0;}
		else{
	...
	public boolean addSheet(String  sheetname){		
		...
		try {
			fis=new FileInputStream(path);
			workbook = new XSSFWorkbook(fis);   // added this since it was throwing exception - when we try to add sheet in newly created work book at run time
			 workbook.createSheet(sheetname);                             // same as above
			 fileOut = new FileOutputStream(path);
			 workbook.write(fileOut);
		     fileOut.close();	
		     fis.close();
	...
	public boolean removeSheet(String sheetName) throws IOException{	
		...
		try {
			...
			System.out.println(sheetName + " Sheet removed successfully");
			fileOut = new FileOutputStream(path);
			workbook.write(fileOut);
		    fileOut.close();
		    fis.close();
